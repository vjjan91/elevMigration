...
![**Phylogenetic paired t-test**
For common species in across the east and the west, A) Seasonal elevational shift is not different in the east (black circles) and the west (blue triangles) (Phylogenetic paired t-test, P<0.001). B) Thermal regime is narrower in the east (black circles) for all species compared to the west (blue triangles) (P<0.001).](figs/fig05.png)  