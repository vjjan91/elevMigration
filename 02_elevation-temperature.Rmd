...
west_data <- write.csv(envWest,"results/westHim_100.csv", row.names = F)
east_data <- write.csv(envEast,"results/eastHim_100.csv", row.names = F)
```
